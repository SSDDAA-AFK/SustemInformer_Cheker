...
class LoaderApp:
    ...
    def stage2(self):
        ...
        self.label.config(
            text="📂 Начинаю проверять файлы..."
        )

        self.progress["value"] = 0

        self.run_bar(20, 30, "Сканирование")
    ...
    def finish(self):
        ...
        self.label.config(
            text="✅ Угрозы не обнаружены!"
        )

        self.status.config(
            text="Нажмите любую кнопку, чтобы закрыть программу."
        )
